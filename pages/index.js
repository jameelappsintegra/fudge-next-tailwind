  ...
  return (
    <div className={styles.container}>
        ...
        <>
          <div className="font-sans bg-gray-100 flex flex-col min-h-screen w-full">
            <div>
              <div className="bg-blue-700">
                <div className="container mx-auto px-4">
                  <div className="flex items-center md:justify-between py-4">
                    ...
                    <div className="w-1/2 md:w-auto text-center text-white text-2xl font-medium">BitCoin</div>
              ...
              <div className="hidden bg-blue-500 md:block md:bg-white md:border-b">
                <div className="container mx-auto px-4">
                  <div className="md:flex">
                    <div className="flex -mb-px mr-8">
                      <a
                        href="#"
                        className="no-underline text-blue-500 md:text-blue-dark flex items-center py-4 border-b border-blue-dark"
                      >
                        <svg
                    ...
                    <div className="flex -mb-px mr-8">
                      <a
                        href="#"
                        className="no-underline text-blue-500 opacity-50 md:text-grey-100 md:opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-grey-dark"
                      >
                        <svg
                          className="h-6 w-6 fill-current mr-2"
                          xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex-grow container mx-auto pt-6 pb-8">
              <div className="bg-white border-t border-b sm:border-l sm:border-r sm:rounded shadow mb-6">
                <div className="border-b px-6">
                  <div className="flex justify-between -mb-px">
                    <div className="lg:hidden text-blue-dark py-4 text-lg">Price Charts</div>
                    <div className="hidden lg:flex">
                      ...
                      <button
                        type="button"
                        className="appearance-none py-4 text-grey-100 border-b border-transparent hover:border-grey-dark mr-6"
                      >
                        Ethereum &middot; CA$884.80
                      </button>
                      <button
                        type="button"
                        className="appearance-none py-4 text-grey-100 border-b border-transparent hover:border-grey-dark"
                      >
                    ...
                    <div className="flex text-sm">
                      <button
                        type="button"
                        className="appearance-none py-4 text-grey-100 border-b border-transparent hover:border-grey-dark mr-3"
                      >
                        1M
                      </button>
                      <button
                      ...
                      <button
                        type="button"
                        className="appearance-none py-4 text-blue-400 border-b border-blue-400 mr-3"
                      >
                        1M
                      </button>
                      <button
                ...
                <div className="hidden lg:flex">
                  <div className="w-1/3 text-center py-8">
                    <div className="border-r">
                      ...
                      <div className="text-sm uppercase text-grey tracking-wide">Bitcoin Price</div>
                    </div>
                  </div>
                  <div className="w-1/3 text-center py-8">
                    <div className="border-r">
                      ...
                      <div className="text-sm uppercase text-grey tracking-wide">Since last month (CAD)</div>
                    </div>
                  </div>
                  <div className="w-1/3 text-center py-8">
                    <div>
                      ...
                      <div className="text-sm uppercase text-grey tracking-wide">Since last month (%)</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="flex flex-wrap -mx-4">
                <div className="w-full mb-6 lg:mb-0 lg:w-1/2 px-4 flex flex-col">
                  <div className="flex-grow flex flex-col bg-white border-t border-b sm:rounded sm:border shadow overflow-hidden">
                    ...
                    <div className="flex-grow flex px-6 py-6 text-grey-100er items-center border-b -mx-4">
                      <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                        <div className="rounded-full bg-orange-200 inline-flex mr-3">
                          <svg
                    ...
                    <div className="flex-grow flex px-6 py-6 text-grey-100er items-center border-b -mx-4">
                      <div className="w-2/5 xl:w-1/4 px-4 flex items-center">
                        <div className="rounded-full bg-purple-400 inline-flex mr-3">
                          <svg
                            className="fill-current text-white h-8 w-8 block"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 38 38"
                    ...
                    <div>
                      <div className="text-center px-6 py-4">
                        <div className="py-8">
                          ...
                          <p className="text-2xl text-grey-100er font-medium mb-4">No buys or sells yet</p>
                          <p className="text-grey max-w-xs mx-auto mb-6">
                            You've successfully linked a payment method and can start buying digital currency.
                          </p>
                          <div>
                            <button
                              type="button"
                              className="bg-blue-500 hover:bg-blue-600 text-white border border-blue-600 rounded px-6 py-4"
                            >
                              Buy now
                            </button>
                          </div>
      ...
      <footer className={styles.footer}>
        <div className="w-full bg-white-100 border-t">
          <div className=" mx-auto px-4">
            <div className="md:flex justify-between items-center text-sm">
              <div className="md:flex text-center md:text-left py-3 md:py-4 border-b md:border-b-0">
                <a href="#" className="no-underline text-grey-100 mr-4">
                  Home
                </a>
                <a href="#" className="no-underline text-grey-100 mr-4">
                  Careers
              ...
              <div className="md:flex md:flex-row-reverse items-center py-4">
                <div className="text-center mb-4 md:mb-0 md:flex">
                  ...
                  <div>
                    <a
                      href="#"
                      className="inline-block leading-tight bg-blue-600 border border-blue-dark hover:bg-blue-400 px-3 py-2 text-white no-underline rounded"
                    >
                      Need help?
                    </a>
                  </div>
